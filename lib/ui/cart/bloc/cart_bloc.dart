    ...
    on<CartEvent>((event, emit) async {
      if (event is CartStarted) {
        ...
        try {
          ...
          if (state is CartSuccess) {
            final successState = (state as CartSuccess);
            final cartIndex = successState.cartResponse.cartItems.indexWhere((element) => element.id == cartItemId);
            successState.cartResponse.cartItems[cartIndex].changeCountLoading = true;
            emit(CartSuccess(successState.cartResponse));

            final newCount = event is CartIncreaseCountButtonClicked
                ? ++ successState.cartResponse.cartItems[cartIndex].count
                : -- successState.cartResponse.cartItems[cartIndex].count;
            ...
            successState.cartResponse.cartItems.firstWhere((element) => element.id == cartItemId)
              ..count = newCount
